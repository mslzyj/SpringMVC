...
public class SpringMVCTest {
	/**
	 * 1.RequestMapping除了修饰方法还可以修饰类 2.类定义处：提供初步的请求映射信息。相对于WEB应用的根目录
	 * 方法处：提供进一步的请求映射信息。相对于类定义处的URL。若类定义处未标注@requestMapping,
...
//		return SUCCESS;
	...
	/**
	 * @CookieValue:映射一个Cookile值。属性同@RequestParam
	 * @param sessionid
	 * @return
	 */
	...
	/**
	 * @RequestMapping支持通配符的情况，下面*处在映射的时候可以随便写一些字符串
	 * @return
	 */
	...
	/**
	 * 可以使用params和headers来更加精确的映射请求，params和handers支持更加精确的表达式。
	 * 并且headers的值必须是"Accept-Language:zh-CN,zh;q=0.8"
	 * @return
	 */
